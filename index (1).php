...
// ================== HÀM GỌI API LAYMA (cURL rồi fallback) ==================

function layma_shortern($targetUrl, $tokenUser) {

    // URL API mới của Layma

    $api_url = "https://api.layma.net/v1/admin/shortlink/quicklink"

        . "?tokenUser=" . urlencode($tokenUser)

        . "&url=" . urlencode($targetUrl)

        . "&link_du_phong=" . urlencode($targetUrl);
...
if (isset($_GET['getkey'])) {
    ...
    $tokenUser = "698ebb287f236393f900583d767b138a";

$result = layma_shortern($realLink, $tokenUser);
